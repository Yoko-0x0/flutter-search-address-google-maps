  ...
  Widget build(BuildContext context) {
    ...
    final container = new Container(
        ...
        child: new Stack(children: <Widget>[
          header,
          new Padding(
              padding: new EdgeInsets.only(top: 48.0, left: 10, right: 10),
              child: body),
        ]));
...
class _GooglePlacesAutocompleteResult
  ...
  @override
  Widget build(BuildContext context) {
    final state = GooglePlacesAutocomplete.of(context);
    assert(state != null);

    if (state.widget.textEditingController.text.isEmpty ||
        state.response == null ||
...
abstract class GooglePlacesAutocompleteState
    extends State<GooglePlacesAutocomplete> {
